...
var TolgeeProviderContext = React.createContext(null);
var TolgeeProvider = function (props) {
    var config = __assign({}, props);
    delete config.children;
    delete config.loadingFallback;
    var _a = __read(useState(Tolgee.use(IcuFormatter).init(__assign({ wrapperMode: 'invisible', ui: process.env.NODE_ENV !== 'development'
            ? undefined
            : typeof require !== 'undefined'
                ? require('@tolgee/ui')
                : import('@tolgee/ui') }, config))), 1), tolgee = _a[0];
    var _b = __read(useState(tolgee.initialLoading), 2), loading = _b[0], setLoading = _b[1];
    ...
    return (React.createElement(TolgeeProviderContext.Provider, { value: __assign(__assign({}, props), { tolgee: tolgee }) }, !loading ? props.children : props.loadingFallback));
};

var useTolgeeContext = function () {
    var context = useContext(TolgeeProviderContext);
    if (context === null) {
...
var useTranslate = function () {
    ...
    var _a = __read(useState(0), 2), instance = _a[0], setInstance = _a[1];
    useEffect(function () {
    ...
    var getTranslation = useCallback(function (key, params, noWrap, defaultValue) {
    ...
    var t = useCallback(function (keyOrProps) {
        var params = [];
...
var useCurrentLanguage = function () {
    ...
    var _a = __read(useState(context.tolgee.lang), 2), language = _a[0], setLanguage = _a[1];
    useEffect(function () {
...
export { T, TolgeeProvider, TolgeeProviderContext, useCurrentLanguage, useSetLanguage, useTranslate };
